...
{
   { slaveDeviceProductGarminProductMaps, "garmin_product", "", (FIT_FLOAT32)1, (FIT_FLOAT32)0, 3, 132 },
};
...
const Profile::MESG Profile::mesgs[MESGS] =
{
   ...
   { sessionFields, "session", FIT_MESG_NUM_SESSION, 73 },
   { lapFields, "lap", FIT_MESG_NUM_LAP, 66 },
   { lengthFields, "length", FIT_MESG_NUM_LENGTH, 14 },
   { recordFields, "record", FIT_MESG_NUM_RECORD, 30 },
